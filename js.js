...
// Estela mágica al mover mouse o dedo
...
// Generación de elementos de fondo
...
function moveNoButton() {
    ...
    btnNo.style.transform = `scale(${noSize}) translateX(0)`; // Reseteamos el transform inicial
    ...
    const frases = [
        "Error ❌", "Infiel", "Intenta de nuevo", 
        "Bien que quieres", "Piénsalo bien", 
        "Te equivocaste de botón", "Yo se que quieres", 
        "Te doy otra oportunidad", "No te hagas la difícil oe"
    ];
